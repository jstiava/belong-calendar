...
export default function LoginPage(props: any) {
  ...
  return (
    <div id="content" className='flex center' style={{ backgroundColor: theme.palette.background.paper, color: theme.palette.text.primary, width: "100vw", height: "100vh" }} >
      <div style={{ width: "20rem", paddingTop: "20vh" }}>
        <h2>Login</h2>
        <div className='flex-col' style={{ alignItems: 'flex-start', gap: '1rem' }}>
          <TextField
            key="username"
            type="username"
            label="Username"
